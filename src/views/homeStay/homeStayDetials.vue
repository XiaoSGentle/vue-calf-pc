    ...
    <div class="u-m-t-10 u-p-40 u-w-1110" style="height: 100vh;  margin: auto;">
      ...
      <el-card>
        ...
        <div class="u-flex">
          ...
          <!-- 酒店评分 -->
          <span class="u-m-t-10 u-m-l-10"><el-rate v-model="homeInfo.score / 1" disabled>
            </el-rate></span>
        ...
        <div class="u-flex">
          ...
          <div class="u-w-650">
            <div class="u-m-t-10 u-font-grey">
              ...
              <div class="u-flex">
                ...
                <span>{{ homeInfo.province }}-{{ homeInfo.city }}-{{ homeInfo.area }}--{{ homeInfo.location }}</span>
            ...
            <div class="u-m-t-50 u-w-600 u-h-300">
              <div class="u-flex">
                ...
                <div class="u-m-l-20 u-h-240 u-w-120">
                  <div class="u-radius" v-for="(item, index) in homeInfo.imageList" :key="index"><img
          ...
          <div class="u-w-380 u-h-370 u-p-20">
            ...
            <!-- 日期选择 -->
            <div> <el-date-picker style="width: 100%" type="daterange" range-separator="至" start-placeholder="入住日期"
                end-placeholder="离店日期" v-model="getData" value-format="yyyy-MM-dd">
              </el-date-picker></div>
            <!-- 收藏人数，评论人数-->
            <div class="u-flex u-row-around u-m-t-50">
              <div><span><svg-icon class="icon" iconClass="shoucang_1" />{{ homeInfo.collectNum }}人收藏</span></div>
              <div><span><svg-icon class="icon" iconClass="pinglun" />{{ homeInfo.commentNum
              }}条评论</span></div>
            </div>
            <div class="u-h-180">
            </div>
            <!-- 提交按钮 -->
            <div class="u-flex "> <el-button style="width: 100%;" type="success" round @click="goAddOrder()">
                立即订房</el-button>
              <div class="u-m-l-10" @click="collectBtn()"><span><svg-icon class="icon"
                    :iconClass="isLiked ? 'hongxin' : 'shoucang'" /></span>
              </div>
            </div>
        ...
        <div class="u-m-t-20">
          ...
          <div v-for="(item, index) in homeQuestions" :key="index" class="u-m-30 ">
            ...
            <div class="u-flex u-row-between">
              <div class="u-flex"><el-avatar :size="30" :src="baseUrl + item.user.avatar"></el-avatar>
                <span class="u-font-22 u-font-bold u-m-l-10">{{ item.content }}</span>
              </div>
              <div>
                {{ item.createTime }}
              </div>
            ...
            <div class="u-m-t-10 u-flex">
              ...
              <span class="u-font-20 u-m-l-10">{{ item.latestAnswer.content }}</span>
            </div>
...
export default {
  ...
  methods: {
    ...
    goAddOrder() {
      this.$router.push({
        name: 'confirmOrder', params: { homeId: this.homeId, data: this.getData }
      })
    },
    collectBtn() {
      if (this.isLiked) {
