  ...
  <div class="u-m-50">
    ...
    <div class="u-m-t-40">
      <div
        class="u-m-t-40"
        style="height: 50px"
        v-for="(item, index) in livingPersionList"
        :key="index"
      >
        <el-row>
          <el-col :span="22"
          ...
          <el-col :span="2"
            ><div style="line-height: 50px">
              <el-link type="primary" @click="getPerById(item.id)"
                >编辑</el-link
              >
              <el-link
                class="u-m-l-20"
                type="primary"
                @click="delPersion(item.id)"
                >删除</el-link
              >
            </div>
          </el-col>
    ...
    <!--对话框 -->
    <el-dialog
      :title="changeType == 1 ? '添加入住人' : '修改入住人'"
